            ...
            child: Stack(
              ...
              children: [
                ...
                if (controller.endAll.value > 0) ...[
                  ...
                  if (height() - (controller.endAll.value * 0.5) <=
                      height(0.05))
                    AnimatedPositioned(
                      duration: 0.milliseconds,
                      left: 0,
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "first section scroll : ${scrollOffset - controller.endForestOffset.value}",
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
      ...
      if (sushiInOffet > 0) ...[
        AnimatedPositioned(
          ...
          top: moveOut > 0
              ...
              : lerpDouble(height(0.6), height(0.735),
        ...
        getImageAnimated(
            ...
            isLeft: false),
        getBoxAnimated(
            moveX: ((moveOut / 0.35) - (((height(.15) + (180 * 2)) / 0.35))) *
                        0.35 >
                    180
                ? ((moveOut / 0.35) - (((height(.15) + (180 * 3)) / 0.35))) *
                    0.35
                : 0,
